...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        ...
        self.picking_ids.write({'vehicle': self.vehicle and self.vehicle.id, 'driver': self.driver and self.driver.id,self.partner_id:self.driver})
        return res
